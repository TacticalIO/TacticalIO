  ...
  var initHSFSKCOM = function(id) {
	...
	self.writeGPIO64Digital = function(args) {
		...
		if (channel >= 0 && channel < 8) {
			...
			throw Error('Wrong channel number: ' + channel);
		}
